...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-2">PERPUSTAKAAN<sup><br/>SMK SUPRIYADI</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/penerbit">PENERBIT BUKU</a>
            <a class="collapse-item" href="/pengarang">PENGARANG BUKU</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"></h6>
            <a class="collapse-item" href="/siswa">DATA ANGGOTA</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Footer -->
      <footer class="sticky-footer bg-white col-xs-12" style="width:100%;">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; PERPUSTAKAAN SMK SUPRIYADI 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <!-- Page level plugins -->
  <script src="<?php echo e(url('assets/vendorchart.js/Chart.min.js')); ?>"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo e(url('assets/js/demo/chart-area-demo.js')); ?>"></script>
  <script src="<?php echo e(url('assets/js/demo/chart-pie-demo.js')); ?>"></script>

</body>

</html>
<?php /**PATH C:\xampp\htdocs\perpustakaan\resources\views/layoutadmin/template.blade.php ENDPATH**/ ?>