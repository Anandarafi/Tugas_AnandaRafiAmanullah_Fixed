  ...
  <section class="main-section">
    ...
    <div class="profile-main" align="center">
        ...
        <tr>
            ...
            <tr>
                <th>JUMLAH BUKU</th>
                <td><?php echo e($datas->eks); ?></td>
            </tr>
        </table>
        <tr>
                    <td><a href="/buku" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Kembali Ke Masa Lalu?')">Kembali Ke Masa Lalu ? </a></td>
                    </tr>
  </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layoutadmin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpustakaan\resources\views/katalog/detail_buku.blade.php ENDPATH**/ ?>