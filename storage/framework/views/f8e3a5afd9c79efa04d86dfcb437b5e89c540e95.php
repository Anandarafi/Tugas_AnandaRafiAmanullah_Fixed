          ...
          <div class="panel-body">
            ...
            <table class="table  table-hover table-striped w-full" style="background :#7F8C8D;width:1570px;">
              ...
              <tr style="color:white;padding:10px;font-family:Arial, Helvetica, sans-serif;">
                ...
                <td align="center"><?php echo e($data->nama_buku); ?></td>
                <td>
				            <a href="<?php echo e(url('/peminjaman/detail/'.$data->id_peminjaman)); ?>" class="btn btn-info btn-sm">DETAIL</a>
                    <a href="<?php echo e(url('/peminjaman/edit/'.$data->id_peminjaman)); ?>" class="btn btn-primary btn-sm">EDIT</a>
                    <a href="/peminjaman/hapus/<?php echo e($data->id_peminjaman); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data?')">DELETE</a>
                </td>
              </tr>
...
<?php echo $__env->make('layoutadmin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpustakaan\resources\views/peminjamanbuku/peminjaman.blade.php ENDPATH**/ ?>